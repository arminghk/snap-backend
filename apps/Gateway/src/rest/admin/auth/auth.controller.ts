...
import { ApiBadRequestResponse, ApiCookieAuth, ApiForbiddenResponse, ApiOperation, ApiTags, ApiUnauthorizedResponse, ApiUnsupportedMediaTypeResponse } from "@nestjs/swagger";
...
import { AdminSignInInputDto, GetAdminProfileOutputDto } from "src/dtos/admin.dto";
...
export class AdminAuthController {
    ...
    @Post('signin')
    @ApiOperation({ summary: "Signin to panel as admin by username and password" })
    async signIn(
